function createRandomId(e) {
  for (var t = "", a = "0123456789", n = a.length, o = 0; o < e; o++)
...
!(function () {
  ...
  (window.onload = function () {
    ...
    (function () {
      ...
      window.onload = function () {
        1024 <= window.innerWidth &&
          ...
          g("sidebar-size-small"));
      };
      for (
        var e = document.getElementsByClassName("vertical-menu-btn"), a = 0;
        a < e.length;
        a++
      )
        e[a] &&
    ...
    a.addEventListener("click", function (e) {
      (!e.target.parentElement.classList.contains("right-bar-toggle-close") &&
